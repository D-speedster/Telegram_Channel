...
PROMPT_TEMPLATE = """پست تلگرام را بهینه کن طوری که طبیعی و انسانی باشد و مشخص نشود ربات نوشته است.

کارها:

اگر متن خبری یا اطلاع‌رسانی است:
- تیتر کوتاه و جذاب با ایموجی اضافه کن (فقط در حد لازم).
- اعداد، تاریخ‌ها و نام کشورها را با ** بولد ** کن.
- متن روان و فشرده باشد.

اگر متن طنز، جوک یا داستان کوتاه است:
- لحن و شوخی متن حفظ شود، هیچ تیتر یا بولدی اضافه نکن.
- متن روان و خوانا شود.

- متن کوتاه، روان و فشرده باشد؛ طولانی و پرجمله نکن.
- کمی محاوره‌ای سبک و دوستانه بنویس، اما طنز مصنوعی یا کلیشه‌ای اضافه نکن.
- یوزرنیم (@)، لینک و فوتر کانال را حذف کن.
- فقط فارسی بنویس.
- تمرکز روی اطلاعات اصلی باشد و چیزی از خودت اضافه نکن مگر برای خوانایی و جذابیت متن.
